                ...
                <div>
                    ...
                    <div class="px-5 pb-5 pt-3 space-y-2">
                        ...
                        <template x-if="!isAuthenticated">
                            <div class="space-y-2">
                                <p class="text-xs text-gray-400 text-center">Sign in to help make this wish come true ✨</p>
                                <a
                                    href="{{ route('login') }}"
                                    class="flex items-center justify-center gap-2 w-full py-3 rounded-2xl bg-gradient-to-r from-violet-500 to-rose-500 text-white text-sm font-bold hover:opacity-90 transition"
                                >
